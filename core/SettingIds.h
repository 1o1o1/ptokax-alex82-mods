...
CRAP_SETBOOL_NO_QUACK_SUPPORTS, 
	// alex82 ... Добавленные настройки
	SETBOOL_SHOW_WELCOME,
	SETBOOL_BLOCK_UNKNOWN_CMD,
	SETBOOL_CHECK_KEYS,
	SETBOOL_USE_COMPRESSION,
	SETBOOL_SCRIPT_ERRORS_TO_OPS,
	SETBOOL_SCRIPT_STACK_TRACEBACK,
	SETBOOL_KEEP_MAGIC_BYTE,
	SETBOOL_LOCK_DELAYED,
...
enum SetShortIds {
	...
	// alex82 ... Добавленные настройки
	SETSHORT_MAX_TEMP_BAN_TIME, 
	SETSHORT_SERVICE_LOOP_INTERVAL, 
#if defined(_WITH_SQLITE) || defined(_WITH_POSTGRES) || defined(_WITH_MYSQL)
