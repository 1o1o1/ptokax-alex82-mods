...
int main(int argc, char* argv[]) {
	...
	while(true) {
	    ...
	    if(bTerminatedBySignal == true) {
			...
			if(CheckSprintf(iMsgLen, clsServerManager::szGlobalBufferSize, "main::restart_message") == true) {
		...
		sleeptime.tv_nsec = clsSettingManager::mPtr->i16Shorts[SETSHORT_SERVICE_LOOP_INTERVAL]*1000000;
