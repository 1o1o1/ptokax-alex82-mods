...
void clsServerManager::Initialize() {
	// alex82 ... ќтключаем самоде€тельность TinyXML, касающуюс€ обработки пробелов в строках
	...
	// alex82 ... ”станавливаем локаль, указанную в настройках
#ifdef _WIN32
	...
	// alex82 ... ѕринудительно устанавливаем локаль дл€ чисел
	setlocale(LC_NUMERIC, "C");

	// alex82 ... „тобы избежать проблем при смене локали, загрузка зарезервированных ников переехала сюда
