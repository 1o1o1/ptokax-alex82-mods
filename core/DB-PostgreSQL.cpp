...
DBPostgreSQL::DBPostgreSQL() {
    ...
    const char * sValues[] = { clsSettingManager::mPtr->sTexts[SETTXT_DB_HOST], clsSettingManager::mPtr->sTexts[SETTXT_DB_PORT], clsSettingManager::mPtr->sTexts[SETTXT_DB_DBNAME], clsSettingManager::mPtr->sTexts[SETTXT_DB_USER], clsSettingManager::mPtr->sTexts[SETTXT_DB_PASS], NULL };
