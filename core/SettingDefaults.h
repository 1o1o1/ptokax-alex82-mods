...
bool SetBoolDef[] = {
    ...
    false, //MODE_TO_MYINFO
    false, //MODE_TO_DESCRIPTION
    true, //STRIP_DESCRIPTION
    false, //STRIP_TAG
    ...
    false, //ADVANCED_PASS_PROTECTION
...
/*CRAP*/false, //NO_QUACK_SUPPORTS
	// alex82 ... Добавленные настройки
	true,	//SHOW_WELCOME
	true,	//BLOCK_UNKNOWN_CMD
	true,	//CHECK_KEYS
	true,	//USE_COMPRESSION 
	true,	//SCRIPT_ERRORS_TO_OPS
	false,	//SCRIPT_STACK_TRACEBACK
	false,	//SETBOOL_KEEP_MAGIC_BYTE
	true,	//SETBOOL_LOCK_DELAYED
#if defined(_WITH_SQLITE)
    true, //ENABLE_DATABASE
#elif defined(_WITH_POSTGRES) || defined(_WITH_MYSQL)
	false, //ENABLE_DATABASE
#endif
};
...
int16_t SetShortDef[] = {
    ...
    2, //MIN_NICK_LEN
    64, //MAX_NICK_LEN
    2, //BRUTE_FORCE_PASS_PROTECT_BAN_TYPE
    ...
    5, //MAX_CONN_SAME_IP
    10, //MIN_RECONN_TIME
	180, //SETSHORT_MAX_TEMP_BAN_TIME
	100, //SETSHORT_SERVICE_LOOP_INTERVAL
...
const char* SetTxtDef[] = {
    "<Введите имя хаба>", //HUB_NAME
    "Admin", //ADMIN_NICK
    "0.0.0.0", //HUB_ADDRESS
    "1209;411", //TCP_PORTS
    "1209", //UDP_PORT
    "<Введите описание хаба>", //HUB_DESCRIPTION
    "rechub.ru", //REDIRECT_ADDRESS
    "reg.hublist.org;serv.hubs-list.com;hublist.te-home.net:2501;dc.gwhublist.com", //REGISTER_SERVERS
    "Извините, этот хаб только для зарегистрированных юзеров.", //REG_ONLY_MSG
    "", //REG_ONLY_REDIR_ADDRESS
    "", //HUB_TOPIC
    "Размер Вашей шары не соответствует правилам хаба. Минимальная шара - %[min], максимальная - %[max].", //SHARE_LIMIT_MSG
    "", //SHARE_LIMIT_REDIR_ADDRESS
    "Количество слотов отдачи не соответствует правилам хаба. Минимум слотов - %[min], максимум - %[max].", //SLOTS_LIMIT_MSG
    "", //SLOTS_LIMIT_REDIR_ADDRESS
    "Ваше соотношение хаб/слот не соответствует правилам хаба. Максимальное соотношение - %[hubs]/%[slots].", //HUB_SLOT_RATIO_MSG
    "", //HUB_SLOT_RATIO_REDIR_ADDRESS
    "Число хабов, к которым Вы подключены, превышает максимально допустимое. Максимум хабов - %[hubs].", //MAX_HUBS_LIMIT_MSG
    "", //MAX_HUBS_LIMIT_REDIR_ADDRESS
    "Ваш клиент не поддерживается или не отправил тэг.", //NO_TAG_MSG
    ...
    "", //OP_CHAT_DESCRIPTION
    "", //OP_CHAT_EMAIL
    "rechub.ru", //TEMP_BAN_REDIR_ADDRESS
    "rechub.ru", //PERM_BAN_REDIR_ADDRESS
    "!+", //CHAT_COMMANDS_PREFIXES
    "", //HUB_OWNER_EMAIL
    "Длина Вашего ника не соответствует правилам хаба. Минимальная длина ника - %[min], максимальная - %[max].", //NICK_LIMIT_MSG
    "", //NICK_LIMIT_REDIR_ADDRESS
    "", //MSG_TO_ADD_TO_BAN_MSG
    "Russian", //LANGUAGE
    "", //IPV4_ADDRESS
    "", //IPV6_ADDRESS
	"Russian_Russia.1251", //LOCALE_WIN
	"ru_RU.CP1251", //LOCALE_NIX
	"cp1251", //ENCODING
