...
const char* LangStr[] = {
	...
	"Charset",
	"Welcome",
	"Show welcome message (This hub is running...)",
	"Block unknown commands",
	"Send $Lock delayed",
	"Check keys in $Key command",
	"Use zlib compression for data transfers",
	"Send script errors to operators",
	"Add stack traceback to script errors",
	"New password",
	"reload IP-To-Country databases",
	"reload IP-To-Country databases",
	"IP-To-Country databases reloaded",
	"Do not process magic byte in $MyINFO command",
	"Maximal temp ban time",
	"Temp ban time can not exceed",
