...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// alex82 ... Костыль, исправляющий работу strcasecmp
#ifdef FIX_STRCASECMP
int str_casecmp(const char *string1, const char *string2 ) {
	unsigned char i;
	char s1[65];
	char s2[65];
	...
	for (i = 0; i < 65; i++) {
		...
		s1[i] = (unsigned char)tolower(string1[i]);
	}
	for (i = 0; i < 65; i++) {
		if (string2[i] == 0) {
			s2[i] = 0;
		...
		s2[i] = (unsigned char)tolower(string2[i]);
	}
